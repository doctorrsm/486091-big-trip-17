...
const createPointEditTemplate = (event) => {
  ...
  const renderAddOffersList = (arrayWithOffers) => arrayWithOffers.map((offer) =>(`
      <div class="event__offer-selector">
                        <input class="event__offer-checkbox  visually-hidden" id="event-offer-${createOfferAttributeName(offer.title)}-${id}" type="checkbox" name="event-offer-${createOfferAttributeName(offer.title)}">
